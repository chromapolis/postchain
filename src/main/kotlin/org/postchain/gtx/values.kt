...
import org.postchain.gtx.messages.DictPair
import java.io.ByteArrayInputStream
import java.io.ByteArrayOutputStream
import java.util.*
import org.postchain.gtx.messages.GTXValue as RawGTXValue
...
class ArrayGTXValue(val array: Array<out GTXValue>): AbstractGTXValue() {
    ...
    override fun getRawGTXValue(): org.postchain.gtx.messages.GTXValue {
...
fun makeDictPair (name: String, value: RawGTXValue): org.postchain.gtx.messages.DictPair {
    val dp = org.postchain.gtx.messages.DictPair()
    dp.name = name
    dp.value = value
    return dp
}
...
class DictGTXValue(val dict: Map<String, GTXValue>): AbstractGTXValue() {
    ...
    override fun getRawGTXValue(): org.postchain.gtx.messages.GTXValue {
        return RawGTXValue.dict(
                Vector<org.postchain.gtx.messages.DictPair>(
